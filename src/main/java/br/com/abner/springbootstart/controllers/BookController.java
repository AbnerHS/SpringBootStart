...
import br.com.abner.springbootstart.util.MediaType;
...
public class BookController {
    ...
    @Operation(summary = "Finds Books by Title", description = "Finds Books by Title", 
    tags = {"Books"}, 
    responses = {
    ...
    public ResponseEntity<PagedModel<EntityModel<BookVO>>> findByName(
    ...
    @PostMapping(
        ...
        produces = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML })
    @Operation(summary = "Adds a new Book", description = "Adds a new Book from a JSON, XML or YML representation of a Book", 
        tags = {"Books"}, 
        responses = {
            @ApiResponse(description = "Success", responseCode = "200", 
                content = @Content(schema = @Schema(implementation = BookVO.class))
    ...
    @PutMapping(
        consumes = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML },
        produces = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML })
    @Operation(summary = "Updates a Book", description = "Updates a Book from a JSON, XML or YML representation of a Book", 
        tags = {"Books"}, 
        responses = {
            @ApiResponse(description = "Success", responseCode = "200", 
                content = @Content(schema = @Schema(implementation = BookVO.class))
